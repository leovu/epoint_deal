  ...
  Widget build(BuildContext context) {
    return ClipRRect(
      ...
      child: Container(
        ...
        child: url == null?(placeholder??CustomPlaceholder()):CachedNetworkImage(
            imageUrl: url!,
            width: width,
            height: height,
...
class CustomAvatar extends StatelessWidget {
  ...
  CustomAvatar({this.url, this.name, this.size, this.borderColor, this.onTap, this.styleName});
      ...
      child: CustomNetworkImage(
        ...
        placeholder: Container(
          ...
          child: AutoSizeText(
            ...
            style:styleName ?? AppTextStyles.style15WhiteBold.copyWith(
              fontSize: size! / 5 * 4
            ),
            minFontSize: 1.0,
          ),
