...
import 'package:epoint_deal_plugin/presentation/multi_staff_screen_customer_care/bloc/multi_staff_screen_customer_care_bloc.dart';
...
class MultipleStaffScreenCustomerCare extends StatefulWidget {
  ...
  @override
  _MultipleStaffScreenCustomerCareState createState() => _MultipleStaffScreenCustomerCareState();
}

class _MultipleStaffScreenCustomerCareState extends State<MultipleStaffScreenCustomerCare> {
  ...
  void initState() {
    ...
    super.initState();
    _bloc = MultipleStaffCustomerCareBloc(context, widget.models, widget.staffs);
  ...
  Future _onRefresh(){
    ...
    if(widget.staffs == null){
      group.add(_bloc.workListStaff(widget.models, _controllerSearch.text, widget.projectId, widget.modelsSelectedCustomerCare));
    }
