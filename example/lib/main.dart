  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      child: InkWell(
        ...
        onTap: () async {
           var result = await EpointDealPlugin.open(context,const Locale(LangKey.langVi, 'vi')  , 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9..hVgL-DAxJ7I-_Uhjp5f0CuZMSj8ICqILkAH11fpWkAk',
